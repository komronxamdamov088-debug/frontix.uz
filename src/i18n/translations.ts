...
export const translations: Record<Lang, Dictionary> = {
  uz: {
    ...
    seo: {
      ...
      team: {
        title: "Jamoa — 16 nafar IT mutaxassis",
        description:
          "FRONTIX jamoasi 16 nafar mutaxassisdan iborat: 3 asoschi, 10 dasturchi, 1 administrator, 1 SMM-mutaxassis, 1 dizayner — Toshkentda loyihalarni boshdan-oxirigacha olib boradi.",
        keywords:
    ...
    hero: {
      ...
      subtitle:
        "FRONTIX — Toshkentda faoliyat yurituvchi IT kompaniya: 16 nafar mutaxassisdan iborat jamoamiz veb-sayt, Telegram bot, QR menyu va CRM avtomatlashtirish yechimlarini 1-6 hafta ichida yaratadi.",
    ...
    team: {
      ...
      pageDescription: "16 nafar mutaxassisdan iborat jamoamiz — asoschilar, dasturchilar, administrator, SMM-mutaxassis va dizayner.",
    ...
    about: {
      ...
      paragraph2:
        "Kichik startaplardan tortib yirik brendlargacha — 16 nafar mutaxassisdan iborat jamoamiz website, Telegram bot, QR menyu va avtomatlashtirish tizimlari orqali o'nlab bizneslarning raqamli transformatsiyasida ishtirok etgan.",
      ...
      milestones: [
        ...
        { year: "2025", title: "16 nafarlik professional jamoa", description: "Bugungi kunda FRONTIX to'liq huquqli, ko'p tarmoqli jamoaga aylandi." },
      ],
    ...
    frx: {
      ...
      teamIntro: "Jamoamiz 16 nafar mutaxassisdan iborat: 3 asoschi, 10 dasturchi, 1 administrator, 1 SMM-mutaxassis va 1 dizayner.",
  ...
  ru: {
    ...
    seo: {
      ...
      team: {
        title: "Команда — 16 IT-специалистов FRONTIX",
        description:
          "Команда FRONTIX — 16 специалистов: 3 основателя, 10 разработчиков, 1 администратор, 1 SMM-специалист и 1 дизайнер. Ведём каждый проект в Ташкенте от начала до конца.",
        keywords:
    ...
    hero: {
      ...
      titleSuffix: " уровень.",
      subtitle:
        "FRONTIX — IT-компания в Ташкенте: команда из 16 специалистов создаёт сайты, Telegram-ботов, QR-меню и CRM-автоматизацию для бизнеса за 1-6 недель.",
    ...
    team: {
      ...
      pageDescription: "Наша команда состоит из 16 специалистов — основатели, разработчики, администратор, SMM-специалист и дизайнер.",
    ...
    about: {
      ...
      paragraph2:
        "От небольших стартапов до крупных брендов — наша команда из 16 специалистов участвовала в цифровой трансформации десятков компаний с помощью сайтов, Telegram-ботов, QR-меню и систем автоматизации.",
      ...
      milestones: [
        ...
        { year: "2025", title: "Команда из 16 специалистов", description: "Сегодня FRONTIX — полноценная многопрофильная команда." },
      ],
    ...
    frx: {
      ...
      teamIntro: "Наша команда состоит из 16 специалистов: 3 основателя, 10 разработчиков, 1 администратор, 1 SMM-специалист и 1 дизайнер.",
  ...
  en: {
    ...
    seo: {
      ...
      team: {
        title: "Team — 16 FRONTIX specialists",
        description:
          "The FRONTIX team has 16 specialists: 3 founders, 10 developers, 1 administrator, 1 SMM specialist and 1 designer, running every project in Tashkent from start to finish.",
        keywords:
    ...
    hero: {
      ...
      titleSuffix: " level.",
      subtitle:
        "FRONTIX is an IT company in Tashkent, Uzbekistan: our team of 16 specialists builds websites, Telegram bots, QR menus and CRM automation in 1-6 weeks.",
    ...
    team: {
      ...
      pageDescription: "Our team of 16 specialists — founders, developers, an administrator, an SMM specialist and a designer.",
    ...
    about: {
      ...
      paragraph2:
        "From small startups to large brands — our team of 16 specialists has taken part in the digital transformation of dozens of businesses through websites, Telegram bots, QR menus and automation systems.",
      ...
      milestones: [
        ...
        { year: "2025", title: "A team of 16 specialists", description: "Today FRONTIX is a full, multi-disciplinary team." },
      ],
    ...
    frx: {
      ...
      teamIntro: "Our team has 16 specialists: 3 founders, 10 developers, 1 administrator, 1 SMM specialist and 1 designer.",
